...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entity.content'
        db.alter_column('crawler_entity', 'content', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Property.content'
        db.alter_column('crawler_property', 'content', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Entity.content'
        db.alter_column('crawler_entity', 'content', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'Property.content'
        raise RuntimeError("Cannot reverse this migration. 'Property.content' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Property.content'
        db.alter_column('crawler_property', 'content', self.gf('django.db.models.fields.TextField')())

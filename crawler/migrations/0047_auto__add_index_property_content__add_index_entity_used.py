...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Property', fields ['content']
        db.create_index('crawler_property', ['content'])

        # Adding index on 'Entity', fields ['used']
        db.create_index('crawler_entity', ['used'])


    def backwards(self, orm):
        # Removing index on 'Entity', fields ['used']
        db.delete_index('crawler_entity', ['used'])

        # Removing index on 'Property', fields ['content']
        db.delete_index('crawler_property', ['content'])

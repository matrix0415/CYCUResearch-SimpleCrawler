...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ExtractionProperty.propertySelector'
        raise RuntimeError("Cannot reverse this migration. 'ExtractionProperty.propertySelector' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ExtractionProperty.propertySelector'
    ...
    models = {
        ...
        'crawler.extractionentity': {
            ...
            'entityPath': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True', 'null': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtractionProperty.entitySelector'
        db.add_column('crawler_extractionproperty', 'entitySelector',
                      self.gf('django.db.models.fields.CharField')(max_length=100, default='123'),
                      keep_default=False)
    ...
    models = {
        ...
        'crawler.extractionproperty': {
            ...
            'entitySelector': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
